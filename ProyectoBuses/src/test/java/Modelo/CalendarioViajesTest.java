...
class CalendarioViajesTest {
    ...
    void OrdenarViajesTest(){
        ...
        ViajeBus viaje1 = new ViajeBus(new Bus(1),Ciudades.TEMUCO,Ciudades.CHILLAN,t1,1);
        ViajeBus viaje2 = new ViajeBus(new Bus(2),Ciudades.TEMUCO,Ciudades.CHILLAN,t2,2);
        ViajeBus viaje3 = new ViajeBus(new Bus(3),Ciudades.TEMUCO,Ciudades.CHILLAN,t3,3);
        viajes.anadirViaje(viaje2);
        viajes.anadirViaje(viaje3);
        viajes.anadirViaje(viaje1);
